...
function getQuestionHTML(question){
    ...
    <li>
    <input type="radio" id="answerOptionOne" name="answerOption" value="${question.optionOne}"> 
    <label for="answerOptionOne">${question.optionOne}</label>
    </li>
    
    <li>
    <input type="radio" id="answerOptionTwo" name="answerOption" value="${question.optionTwo}"> 
    <label for="answerOptionTwo">${question.optionTwo}</label>
    </li>
    
    <li>
    <input type="radio" id="answerOptionThree" name="answerOption" value="${question.optionThree}"> 
    <label for="answerOptionThree">${question.optionThree}</label>
    </li>
    
    <li>
    <input type="radio" id="answerOptionFour" name="answerOption" value="${question.optionFour}"> 
...
function init(){
    ...
    $('#qa-js-submit-btn').on('click', handleSubmitAnswer);
